...
export default function TerminalContent({ section, isTyping }: TerminalContentProps) {
...
about      - Display detailed information about Krati
skills     - Show technical skills and expertise areas  
experience - View work experience and key achievements
projects   - Browse featured projects and contributions
...
Ready for exploration? Try 'about' to get started!
    `,
    about: `
...
Shell: /bin/bash
Home: /home/krati
Groups: developers, engineers, innovators

Last Login: Currently Active
Session: Interactive Terminal Portfolio
Uptime: Building the future since 2020
    `,
  }

  const currentContent = content[section as keyof typeof content] || content.welcome
